window.onload =()=> {
  ...
  body.style.backgroundColor = 'gray'
    ...
    fragment.appendChild(divContainer)
      ...
      divRow.innerHTML
      divRow.style.border = '5px solid green'
      divRow.style.color = 'blue'
      divContainer.appendChild(divRow)

      for (let i = 0; i < users.length; i++){

        let divCol = document.createElement('div')
        divCol.className = 'col bg-black border'
        divCol.innerHTML
        ...
        address.innerHTML = users[i].address.city
